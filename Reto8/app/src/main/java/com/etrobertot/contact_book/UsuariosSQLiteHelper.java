...
public class UsuariosSQLiteHelper extends SQLiteOpenHelper {
    ...
    String sqlCreate = "CREATE TABLE Usuarios (codigo INTEGER PRIMARY KEY AUTOINCREMENT, nombre TEXT, url TEXT, telefono TEXT," +
            "email TEXT, servicio TEXT, clasificacion TEXT)";
